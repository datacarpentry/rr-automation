...
* `R`: our R code (the functions), it's often easier to keep the prose from the
  manuscript separated from the code. If you have a lot of code (and/or if the
  manuscript is long), it's easier to navigate.
