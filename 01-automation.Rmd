...
Ideally, your code should be written such that it's easy to understand and your
...
do you keep the duplicated comments in sync? Re-organizing (or organizing) your
analysis in functions from the beginning will allow you to explicitly document
the dataset or the parameters on which your function, and therefore your
results, depends on.
