...
![Functionalize all the things!](/img/functionalize_all_the_things.png)
...
up with a piece of your that works but is klunky. If you thrive on geekiness you
might endup over engineer a part of your code and make it more difficult to
understand a few weeks later. In all of these situations, and even if you think
your code is clear, it's important that you document your code for your
collaborators, and your future self.

If all your analysis is made up of scripts, with pieces that are repeated in
multiple parts of your document, things can get out of hands pretty quickly. Do
you also duplicate your comments where you duplicate parts of your scripts? How
do you keep the duplicated comments in sync? Re-organizing your scripts into
functions (or organizing your analysis in functions from the beginning) will
allow you to explicitly document the dataset or the parameters on which your
function, and therefore your results, depends on.

The easy way to document your code, is to simply to add comments around your
function to explicitly indicate what the function is doing, what the arguments
are supposed to be and the kind of output you will get from it.
